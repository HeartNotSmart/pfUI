pfUI:RegisterModule("gui", "vanilla:tbc", function ()
  ...
  do -- Generate Config UI
    ...
    CreateGUIEntry(T["Unit Frames"], T["General"], function()
      ...
      CreateConfig(nil, T["Translate Unit Frames (WoWTranslate)"], C.unitframes, "translate_wowtranslate", "checkbox")
    ...
    CreateGUIEntry(T["Chat"], nil, function()
      ...
      CreateConfig(U["chat"], T["Enable Text Shadow"], C.chat.text, "outline", "checkbox")
      CreateConfig(U["chat"], T["Chat Text Style"], C.chat.text, "fontstyle", "dropdown", pfUI.gui.dropdowns.fontstyle)
